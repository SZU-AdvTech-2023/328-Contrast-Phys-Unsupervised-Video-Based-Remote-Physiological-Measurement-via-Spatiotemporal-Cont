...
def my_config():
    ...
    result_dir = '/data/xieyiping/projectone/Physnet/Contrast-phys/result' # store checkpoints and training recording
...
def my_main(_run, total_epoch, fs, T, S, lr, in_ch, result_dir, delta_t, K):
    ...
    # 训练数据中没有标签
    dataset = UBFCdataset(train_list, T) # please read the code about H5Dataset when preparing your dataset
